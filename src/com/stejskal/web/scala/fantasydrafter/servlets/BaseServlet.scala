...
import com.stejskal.web.scala.fantasydrafter.models.{FantasyTeam, Player}
...
class BaseServlet extends HttpServlet
{
  ...
  override def doGet(request: Request, response: Response)
  {
    ...
    context.layout("/com/stejskal/web/scala/fantasydrafter/screens/default.scaml", Map("myTeam" -> getMyTeamList,
      "draftHistory" -> getDraftHistoryList, "pickList" -> getPickList, "teams" -> getAllFantasyTeams, "cssFiles" -> cssFiles))
    {
      context.render("com/stejskal/web/scala/fantasydrafter/divs/PlayerTable.scaml", Map("players" -> getSearchTableList))
    }
